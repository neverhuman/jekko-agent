...
jekko-agent release readiness is intentionally conservative for the split-port branch. Version source is the root `Cargo.toml` and any package manifest copied with the owned surface. Release history is tracked in `CHANGELOG.md`.
